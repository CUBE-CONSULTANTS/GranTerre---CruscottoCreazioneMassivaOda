		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Creazione Massiva OdA(+ Entrata Merce)",
									"targetURL": "#granterrecreazionemassiva-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"granterrecreazionemassiva-display": {
								"semanticObject": "granterrecreazionemassiva",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=granterre.creazionemassiva",
									"url": sap.ui.require.toUrl("granterre/creazionemassiva")
								}
							}
						}
					}
